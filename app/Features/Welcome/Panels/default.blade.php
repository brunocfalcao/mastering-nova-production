    ...
    <div class="mt-3 text-center">
        ...
        <div class="mt-2 px-7 py-3">
            <p class="text-sm text-black">
                At this moment you cannot buy this course since it was built for Laravel Nova version 3.0<br/><br/>
                I am planning to release the new 4.0 version still this year. Sorry for the delay!</u>.
            </p>
        </div>
