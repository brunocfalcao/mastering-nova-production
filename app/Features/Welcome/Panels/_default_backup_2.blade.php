...
@guest
<div
    class="fixed block inset-0 bg-richblack-900 bg-opacity-75 overflow-y-auto h-full w-full z-201"
    id="my-modal"
>
    <div
    class="relative m-64 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white z-201">
    <div class="mt-3 text-center">
        ...
        <h3 class="text-lg leading-6 font-medium text-gray-900">For your attention</h3>
        <div class="mt-2 px-7 py-3">
            <p class="text-sm text-black">
                The current course is made for the version 3.x (Orion),
                but the Laravel team will deploy a new major version (4.x) in the upcoming weeks.<br/><br/> Later on I will also
                record the videos for the new version and <u>you will not need to pay more</u>.
            </p>
        </div>
